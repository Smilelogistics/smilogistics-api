...
Route::get('/config/maps', [UnivController::class, 'getMapsData']);
    ...
    Route::get('/verify-payment/flutterwave', [TransactionsController::class, 'verifyFlutterwavePayment']);
    ...
    Route::post('/register', [AuthController::class, 'register']);
        ...
        Route::middleware('subscription:basic')->group(function () {
            ...
            Route::put('/shipments/driver-shipment-update/{id}', [ShipmentController::class, 'driverShipmentUpdate'] );
