        ...
        <table border="0" cellspacing="0" cellpadding="0" style="color:#0f3462; font-family: sans-serif;">
          ...
          <tr>
            <td style="text-align: center;">
              <h4 style="margin: 0px;padding-bottom: 25px; margin: auto; text-transform: uppercase; font-size:22px;">Consolidate Shipment Uploaded Successfully</h4>
              <p style=" margin: 0px 40px;padding-bottom: 25px;line-height: 2; font-size: 15px;">
                Hello {{ $consolidateShipment['reciever_name'] ?? 'Customer' }}, your Shipment has been uploaded successfully with tracking number <b>{{ $consolidateShipment['consolidate_tracking_number'] ?? '' }}</b>
                <br>
          ...
          <tr>
            <td style="text-align:center;">
              ...
              <div style="margin-bottom: 25px; font-size: 15px;margin-top:7px;">
                Give us a call {{ optional($branch)->phone ?? 'N/A' }}
              </div>
            </td>
          </tr>
        </table>
