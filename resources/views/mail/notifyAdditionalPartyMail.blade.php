         ...
         @endphp
          ...
          <tr>
            <td style="text-align: center;">
              ...
              <p style=" margin: 0px 40px;padding-bottom: 25px;line-height: 2; font-size: 15px;">Hello {{$shipment['second_notify_party_name']}} your shipment has been uploaded successfully with tracking number <b> {{$shipment['shipment_tracking_number']}} </b>, you are a consignee of this shipment<br>
