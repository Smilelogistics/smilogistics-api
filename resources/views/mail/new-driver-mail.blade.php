        ...
        <tr><td style="padding:32px 28px 28px 28px;">
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
            <tr><td class="body" style="font-family:Arial,Helvetica,sans-serif; font-size:16px; line-height:26px; color:#6B7280; text-align:center;">
              Hello, your driver account has been successfully created.<br>
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="panel" style="background:#143D96; color:#FFFFFF; border-radius:16px;">
            <tr><td style="padding:18px 16px;">
              <p style="margin:0; font-family:sans-serif,Arial,Helvetica; font-weight:600; font-size:18px; line-height:24px;">Email: {{ $createUser['email'] }}</p>
              <div class="sp-8"></div>
              <p style="margin:0; font-family:sans-serif,Arial,Helvetica; font-weight:600; font-size:18px; line-height:24px;">Temporary Password: 123456789</p>
            </td></tr>
          </table>
