        ...
        <table border="0" cellspacing="0" cellpadding="0" style="color:#0f3462; font-family: sans-serif;">
          ...
          <tr>
            <td style="text-align: center;">
              <h4 style="margin: 0px;padding-bottom: 25px; text-transform: uppercase; font-size:22px;">Your Carrier Account Created Successfully</h4>
              <!-- <h2 style="margin: 0px;padding-bottom: 25px;font-size:22px;"> Please renew your subscription</h2> -->
              <p style=" margin: 0px 40px;padding-bottom: 25px;line-height: 2; font-size: 15px;">Hello, {{$data['name']}} Your account is created suceesfuly you can download our app and start using it  <br>
              </p>
