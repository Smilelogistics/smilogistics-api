...
class StoreShipmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'pickups' => 'nullable|array|min:1',
            'pickups.*.pick_up' => 'nullable|string',
            'pickups.*.location_name' => 'nullable|string',
            'pickups.*.address' => 'nullable|string',
            'pickups.*.city' => 'nullable|string',
            'pickups.*.state' => 'nullable|string',
            'pickups.*.zip' => 'nullable|string',
            'pickups.*.appt_date' => 'nullable|date',
            'pickups.*.no_latter_than_date' => 'nullable|date',
            'pickups.*.no_latter_than_time' => 'nullable',
            'pickups.*.coordinates' => 'nullable|array',
            'pickups.*.coordinates.lat' => 'nullable|numeric',
            'pickups.*.coordinates.lng' => 'nullable|numeric',
            'dropoffs' => 'nullable|array|min:1',
            'dropoffs.*.drop_at' => 'nullable|string',
            'dropoffs.*.location_name' => 'nullable|string',
            'dropoffs.*.address' => 'nullable|string',
            'dropoffs.*.city' => 'nullable|string',
            'dropoffs.*.state' => 'nullable|string',
            'dropoffs.*.zip' => 'nullable|string',
            'dropoffs.*.appt_date' => 'nullable|date',
            'dropoffs.*.no_latter_than_date' => 'nullable|date',
            'dropoffs.*.no_latter_than_time' => 'nullable',
            'dropoffs.*.coordinates' => 'nullable|array',
            'dropoffs.*.coordinates.lat' => 'nullable|numeric',
            'dropoffs.*.coordinates.lng' => 'nullable|numeric',
            'totalDistance' => 'nullable|numeric|min:0',
            'totalCharge' => 'nullable|numeric|min:0',
            'baseRate' => 'nullable|numeric|min:0',
            'distanceCharge' => 'nullable|numeric|min:0',
